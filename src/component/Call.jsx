...
export default () => {
    return (
        <div style={{ marginLeft: 10 }}>
            ...
            • IJMSR invites original, previously unpublished, research papers, review, survey and tutorial papers, application papers, plus case studies, short research notes and letters, on both applied and theoretical aspects.<br/>
            ...
            • Upon acceptance for publication transfer of copyright will be made to ADWEN HOUSE PUBLISHING LIMITED, author will be requested to pay a mandatory publication charge. Article submission implies author agreement with this policy.<br/>
            ...
            Submission of your paper to this journal implies that the paper is not under submission for publication elsewhere. Material which has been previously copyrighted, published, or accepted for publication will not be considered for publication in this journal. Submission of a manuscript is interpreted as a statement of certification that no part of the manuscript is copyrighted by any other publisher nor is under review by any other formal publication. By submitting your manuscript to us, you agree on ADWEN HOUSE PUBLISHING LIMITED copyright guidelines. It is your responsibility to ensure that your manuscript does not cause any copyright infringements, defamation, and other problems.Submitted papers are assumed to contain no proprietary material unprotected by patent or patent application; responsibility for technical content and for protection of proprietary material rests solely with the author(s) and their organizations and is not the responsibility of the ADWEN HOUSE PUBLISHING LIMITED or its Editorial Staff. The main author is responsible for ensuring that the article has been seen and approved by all the other authors. It is the responsibility of the author to obtain all necessary copyright release permissions for the use of any copyrighted materials in the manuscript prior to the submission. 
            <h3>Publication Charges and Orders:</h3>
            All the journals published by ADWEN HOUSE PUBLISHING LIMITED are ‘Open Access’ journals, which means that the publication cost should be covered by the author's institution or research funds.  <br/>
            The author's company or institution will be requested to pay a flat publication fee of EUR 200 for an accepted manuscript regardless of the length of the paper. The publication charges are mandatory.  <br/>
